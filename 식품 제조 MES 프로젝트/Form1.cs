...
namespace MES_UI
{
    public partial class Form1 : Form
    {
        ...
        private void iconButton2_Click(object sender, EventArgs e)
        {
            ...
            string A = "select PD.PMName as 재고명, SUM(s.StQty) as 수량, PD.PMUnit as 단위 from PdMaster PD join Stock S on PD.PMid = S.PMId GROUP BY PD.PMName, PD.PMUnit order by PMUnit desc";
